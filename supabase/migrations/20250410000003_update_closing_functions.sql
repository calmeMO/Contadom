-- Script para actualizar funciones que hacen referencia a closing_history
-- Contadom - Migración para eliminar referencias a closing_history

-- 1. Actualizar función generar_asiento_cierre_resultados
...
-- 2. Actualizar función generar_asiento_apertura
...
-- 3. Actualizar función reabrir_periodo_contable 
...
-- 4. Actualizar función consultar_estado_cierre para que no use closing_history
